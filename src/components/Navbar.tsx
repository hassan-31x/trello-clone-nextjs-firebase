    ...
    <nav className="w-full bg-black text-white flex h-14 items-center px-4 justify-between">
      ...
      <div className="left flex h-full items-center gap-10">
        ...
        <div className="nav-items flex gap-4 w-full items-center">
          <p className='flex gap-1 h-full items-center text-sm'>Workspace <IoIosArrowDown /></p>
          <p className='flex gap-1 h-full items-center text-sm'>Recent <IoIosArrowDown /></p>
          <p className='flex gap-1 h-full items-center text-sm'>More <IoIosArrowDown /></p>
          <IconContext.Provider value={{ className: 'text-3xl bg-gray-700 text-white py-1 rounded-md ml-2'}}>
            <AiOutlinePlus />
      ...
      <div className="right flex h-full items-center gap-3">
        ...
        <div className='text-[0.6rem] bg-green-600 rounded-full w-6 h-6 flex justify-center items-center'>MK</div>
      </div>
